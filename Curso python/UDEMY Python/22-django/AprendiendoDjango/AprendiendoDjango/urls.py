...
from django.conf import settings #para config imagenes

#importar app con mis vistas
from miapp import views
#se puede usar import miapp.views cambiando los nombres a miapp.views.

urlpatterns = [
    path('admin/', admin.site.urls),
    path("",views.index, name="index"), #cuando esta vacio ("")es la ruta principal
...
# config para cargar imagenes
if settings.DEBUG:
    from django.conf.urls.static import static #pasa url a un fichero statico
