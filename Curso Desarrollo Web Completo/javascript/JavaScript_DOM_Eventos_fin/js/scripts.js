...
formulario.addEventListener('submit', function(e) {
    e.preventDefault(); // este prevent hace que no se recargue la pagina
...
function leerTexto(e) {
    ...
    datos[e.target.id] = e.target.value; //sirve para colocar lo que se ecribe en los campos sobre el objeto
